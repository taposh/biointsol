...
<span class="aspnetmaker">Delete from TABLE: Gallery</span><br />
...
<asp:Label id="lblSql" CssClass="aspnetmaker" runat="server" /><br />
	...
	<Columns>
	<asp:TemplateColumn HeaderText="Gallery ID">
		<ItemTemplate>
...
<script language="VB" runat="server">
	...
	Private Sub BindData()
		...
		For i = 0 to ubound(arrKey)
			sDbWhere += "[GalleryID] = " & arrKey(i) & " OR "
		Next	
		sDbWhere = Left(sDbWhere,Len(sDbWhere)-4)
		Dim sSelect As String
		sSelect = "SELECT * FROM [Gallery] WHERE " & sDbWhere
		lblSql.Text = sSelect
	...
	Private Function DeleteData() As Boolean
		...
		sDbWhere = Left(sDbWhere,Len(sDbWhere)-4)
		Dim sSQL As String
		sSQL = "DELETE FROM [Gallery] WHERE " & sDbWhere
		Try
