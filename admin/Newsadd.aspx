...
<span class="aspnetmaker">Add to TABLE: News</span><br />
<form
...
<script language="VB" runat="server">
	...
	Private Function AddData() As Boolean
		...
		sFields = "": sParms = ""
		sFields += "[NewsHeadline], ": sParms += "@NewsHeadline, "
		sFields += "[NewsDate], ": sParms += "@NewsDate, "
		sFields += "[NewsBody], ": sParms += "@NewsBody, "
		sFields += "[Frontpage], ": sParms += "@Frontpage, "
