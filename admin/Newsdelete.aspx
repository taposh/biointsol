...
<span class="aspnetmaker">Delete from TABLE: News</span><br />
...
<asp:Label id="lblSql" CssClass="aspnetmaker" runat="server" /><br />
	...
	<asp:TemplateColumn HeaderText="News Date">
		<ItemTemplate>
			<asp:Label id="x_NewsDate" CssClass="aspnetmaker" runat="server" />
		</ItemTemplate>
	</asp:TemplateColumn>
	<asp:TemplateColumn HeaderText="Frontpage">
		<ItemTemplate>
...
<script language="VB" runat="server">
	...
	Private Sub BindData()
		...
		For i = 0 to ubound(arrKey)
			sDbWhere += "[NewsID] = " & arrKey(i) & " OR "
		Next	
		sDbWhere = Left(sDbWhere,Len(sDbWhere)-4)
		Dim sSelect As String
		sSelect = "SELECT * FROM [News] WHERE " & sDbWhere
		lblSql.Text = sSelect
	...
	Private Function DeleteData() As Boolean
		...
		sDbWhere = Left(sDbWhere,Len(sDbWhere)-4)
		Dim sSQL As String
		sSQL = "DELETE FROM [News] WHERE " & sDbWhere
		Try
