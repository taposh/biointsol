...
<span class="aspnetmaker">Delete from TABLE: Products</span><br />
...
<asp:Label id="lblSql" CssClass="aspnetmaker" runat="server" /><br />
	...
	<asp:TemplateColumn HeaderText="Product Brochure Location">
		<ItemTemplate>
...
<script language="VB" runat="server">
	...
	Private Sub BindData()
		...
		For i = 0 to ubound(arrKey)
			sDbWhere += "[ProductID] = " & arrKey(i) & " OR "
		Next	
		sDbWhere = Left(sDbWhere,Len(sDbWhere)-4)
		Dim sSelect As String
		sSelect = "SELECT * FROM [Products] WHERE " & sDbWhere
		lblSql.Text = sSelect
	...
	Private Function DeleteData() As Boolean
		...
		sDbWhere = Left(sDbWhere,Len(sDbWhere)-4)
		Dim sSQL As String
		sSQL = "DELETE FROM [Products] WHERE " & sDbWhere
		Try
