...
<span class="aspnetmaker">Add to TABLE: Resources</span><br />
<form
...
<script language="VB" runat="server">
	...
	Private Function AddData() As Boolean
		...
		sSQL = "INSERT INTO [Resources]"
		sFields = "": sParms = ""
		sFields += "[ResourceName], ": sParms += "@ResourceName, "
		sFields += "[ResourceAbstract], ": sParms += "@ResourceAbstract, "
		sFields += "[ResourceDesc], ": sParms += "@ResourceDesc, "
		sFields += "[NewsID], ": sParms += "@NewsID, "
		sFields += "[ProductID], ": sParms += "@ProductID, "
		sFields += "[ResourceURL], ": sParms += "@ResourceURL, "
		sFields += "[ResourceLocation], ": sParms += "@ResourceLocation, "
